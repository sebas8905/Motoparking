...
import com.acktos.motoparking.util.SystemUiHider;
...
public class SplashScreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLabel = (TextView)findViewById(R.id.loadlabel);
    ...
    private class GetParkingsTask extends AsyncTask<Void,Void,ArrayList<Parking>>
    {
        @Override
        ...
        protected void onPostExecute(ArrayList<Parking> parkings) {
            loadLabel.setVisibility(View.GONE);
            Intent intent_name = new Intent();
            intent_name.setClass(getApplicationContext(),MapActivity.class);
        ...
        protected ArrayList<Parking> doInBackground(Void... params) {
            ParkingController parkingController = new ParkingController(SplashScreenActivity.this);
